...
The implementation is complete through Task 0122. It includes the multicycle
...
I/O registers, reset-vector fetch, maskable/NMI entry, and the architectural
illegal-opcode trap. Video timing and refresh blocks exist as standalone
modules. Read `tasks.md` and the current-status sections in
